...
import styles from '@/app/product-page/HeroSection.module.css';
...
const HeroSection_backup: React.FC<Props> = ({ data }) => {
  // const imageUrl = data.image ? getStrapiMedia(data.image) : null;
  const imageUrl = getStrapiMedia(data.image) || '/images/travel-product-page-web.jpg';
  console.log('HeroSection imageUrl from strapi :', imageUrl);

  // const imageUrl =  '/images/travel-product-page-web.jpg';
  // console.log('HeroSection imageUrl hardcoded:', imageUrl);
...
export default HeroSection_backup;